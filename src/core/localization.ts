...
const translations = {
  de: {
    ...
    editControlCommands: "Start/Stop/Restart/Status bearbeiten",
    controlCommandsSaved: "Start/Stop/Restart/Status gespeichert.",
  ...
  en: {
    ...
    editControlCommands: "Configure Start/Stop/Restart/Status",
    controlCommandsSaved: "Start/Stop/Restart/Status commands saved.",
